...
import org.lineage.gameserver.model.zone.*;
import org.lineage.gameserver.model.zone.form.ZoneCuboid;
import org.lineage.gameserver.model.zone.form.ZoneCylinder;
import org.lineage.gameserver.model.zone.form.ZoneNPoly;
import org.lineage.gameserver.model.zone.type.*;
			...
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("zone".equalsIgnoreCase(d.getNodeName()))
					{
						...
						try
						{
							newZone = Class.forName("org.lineage.gameserver.model.zone.type." + zoneType);
