...
public class Forum
{
	...
	/**
	 * Creates new instance of Forum. When you create new forum, use {@link org.lineage.gameserver.communitybbs.Manager.ForumsBBSManager# addForum(org.lineage.gameserver.communitybbs.BB.Forum)} to add forum to the forums manager.
	 * @param forumId
	 * @param fParent
	 */
