 ...
 */
package org.lineage.gameserver.engines.items;

import org.lineage.gameserver.engines.DocumentBase;
...
public class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			final Constructor<?> itemClass = Class.forName("org.lineage.gameserver.model.items." + _currentItem.type).getConstructor(StatSet.class);
