...
import org.lineage.gameserver.datatables.NpcPersonalAIData;
...
import org.lineage.gameserver.model.zone.type.NpcSpawnTerritory;
import org.lineage.gameserver.taskmanager.RespawnTaskManager;
...
public class Spawn extends Location implements IIdentifiable, INamable
{
	...
	public Spawn(NpcTemplate template) throws ClassNotFoundException, NoSuchMethodException, ClassCastException
	{
		...
		_constructor = Class.forName("org.lineage.gameserver.model.actor.instance." + _template.getType() + "Instance").asSubclass(Npc.class).getConstructor(NpcTemplate.class);
	}
