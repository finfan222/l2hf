 ...
 */
package org.lineage.gameserver.model.stats;
...
import org.lineage.gameserver.data.xml.impl.HitConditionBonusData;
import org.lineage.gameserver.data.xml.impl.KarmaData;
import org.lineage.gameserver.enums.ShotType;
import org.lineage.gameserver.instancemanager.*;
import org.lineage.gameserver.model.SiegeClan;
import org.lineage.gameserver.model.actor.Creature;
import org.lineage.gameserver.model.actor.instance.*;
...
import org.lineage.gameserver.model.entity.Siege;
...
import org.lineage.gameserver.model.stats.functions.formulas.*;
import org.lineage.gameserver.model.zone.ZoneId;
import org.lineage.gameserver.model.zone.type.CastleZone;
import org.lineage.gameserver.model.zone.type.ClanHallZone;
import org.lineage.gameserver.model.zone.type.FortZone;
import org.lineage.gameserver.model.zone.type.MotherTreeZone;
...
public class Formulas {
	...
	/**
	 * Formula based on http://l2p.l2wh.com/nonskillattacks.html<br>
	 * Additional mechanic for skills/spells. Spells can be missed with less 3.0 rate, skills with less 2.0 rate.<br>
	 * @param attacker
	 * @param target
	 * @return {@code true} if hit missed (target evaded), {@code false} otherwise.
	 */
