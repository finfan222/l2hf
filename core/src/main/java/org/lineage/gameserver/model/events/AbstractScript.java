...
import org.lineage.gameserver.model.events.annotations.*;
import org.lineage.gameserver.model.events.impl.IBaseEvent;
import org.lineage.gameserver.model.events.impl.creature.OnCreatureKill;
import org.lineage.gameserver.model.events.impl.creature.OnCreatureZoneEnter;
import org.lineage.gameserver.model.events.impl.creature.OnCreatureZoneExit;
...
import org.lineage.gameserver.model.events.listeners.*;
import org.lineage.gameserver.model.events.returns.AbstractEventReturn;
...
import org.lineage.gameserver.model.instancezone.InstanceWorld;
import org.lineage.gameserver.model.interfaces.IPositionable;
...
import org.lineage.gameserver.scripting.ManagedScript;
import org.lineage.gameserver.util.MinionList;
...
public abstract class AbstractScript extends ManagedScript
{
	...
	/**
	 * Provides delayed (Depending on {@link org.lineage.gameserver.model.actor.Attackable#getOnKillDelay()}) callback operation when Attackable dies from a player.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.lineage.gameserver.model.actor.Creature} Enters on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.lineage.gameserver.model.actor.Creature} Exits on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.lineage.gameserver.model.actor.instance.TrapInstance} acts.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	 ...
	 * Use this method instead of importing {@link org.lineage.commons.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link org.lineage.gameserver.GameTimeController}.
	 */
